...
if (!store.includes("schemaVersion: 11")) issues.push("Initial save schema must be version 11.");
...
for (const field of ["visitCounts", "evidenceIds", "knowledgeIds", "events", "seenEndingIds", "achievementsUnlocked", "unlockedTextEntryIds", "readTextEntryIds", "solvedDeductionIds", "deductionAttempts", "activeLeadId", "investigationNodeIds", "completedOperationIds", "unlockedSideCaseIds"]) {
